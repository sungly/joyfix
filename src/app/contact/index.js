...
class ContactUs extends Component {
  ...
  configureDisplay = () => {
    if (this.state.submitted) {
      return (
        <React.Fragment>
          <h1>Thank you for your question. We'll get back to you as soon as possible!</h1>
    ...
    return (
      <React.Fragment>
        ...
        <input type="text" placeholder="Name" onChange={e => this.handleNameInput(e)} />
        <input type="text" placeholder="Topic" onChange={e => this.handleTopicInput(e)} />
        <input type="textbox" placeholder="Comment" onChange={e => this.handleCommentInput(e)} />
  ...
  render() {
    return (
      <PageContainer>
        <NavBar />
        <Form.PageContainer>
          <Form.FormContainer>{this.configureDisplay()}</Form.FormContainer>
        </Form.PageContainer>
      </PageContainer>
    );
  }
